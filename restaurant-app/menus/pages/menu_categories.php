...
<head>
    ...
    .card-img-top img {
        display: none; /* Remove old img styling */
    }
        ...
        <div class="row row-cols-1 row-cols-md-2 row-cols-lg-3 g-4 center-cards">
            ...
            if ($result_categories->num_rows > 0) {
                while ($row = $result_categories->fetch_assoc()) {
                    // Fix image path for category images - assets is in menus/, need only ../
                    $category_image_url = htmlspecialchars($row["image_url"]);
                    if (strpos($category_image_url, '../') !== 0 && strpos($category_image_url, 'http') !== 0) {
                    ...
                    echo '<img src="' . $category_image_url . '" class="card-img-top" alt="category" onerror="this.src=\'../assets/imgs/placeholder.jpg\'" />';
